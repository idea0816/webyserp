 ...
 * @Description MES - 成型產量資料(Process)
 *
 */
...
const OutptuAss = ({ Dep, Date, commURL, lineGoals }) => {
  ...
  useEffect(() => {
    ...
    let getOutputAss = () => {
      axios({
        method: "get",
        baseURL: API_URL,
        url: "MES/getAssOutput?depName=" + Dep + "&dateTime=" + Date,
    ...
    getOutputAss(); // eslint-disable-next-line react-hooks/exhaustive-deps
    calPercent();
